...
checkpoint = '/dataset/checkpoints/baseline_pretrained.ckpt'
...
def train():
    ...
    # Al ser simplemente para hacer test, no es necesario definir los hiperparámetros de pretrained, se cargan los mejores pesos del entrenamiento
    pretrained_model = False
    learning_rate = 0.0001915997902143788
    batch_size = 2
